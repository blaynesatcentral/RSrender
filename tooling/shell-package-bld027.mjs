...
export async function packageBoringLogPdfStudio() {
  ...
  return Object.freeze({
    ...source,
    schema: "rsrender.bld027.package-result.v1",
    result: "PASS",
    paths: Object.freeze({
      temporaryRoot,
      outputDirectory,
    ...
    publicationMode: "same-scene-layout-host-print-to-pdf",
  });
}

export const BLD027_PATHS = Object.freeze({
  temporaryRoot,
  outputDirectory,
  packagedDirectory,
  packagedExecutable,
...
const invokedDirectly = process.argv[1]
  ...
  : false;
if (invokedDirectly) console.log(JSON.stringify(await packageBoringLogPdfStudio()));
